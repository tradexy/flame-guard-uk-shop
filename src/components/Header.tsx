        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col space-y-2">
              <a href="#shop" className="text-gray-700 hover:text-red-600 py-2">Shop By Category</a>
              <a href="#shop" className="text-gray-700 hover:text-red-600 py-2">Shop For</a>
              <a href="#about" className="text-gray-700 hover:text-red-600 py-2">About Us</a>
              <a href="#faq" className="text-gray-700 hover:text-red-600 py-2">FAQ</a>
              <a href="#mission" className="text-gray-700 hover:text-red-600 py-2">Our Mission</a>
              <a href="#support" className="text-gray-700 hover:text-red-600 py-2">Servicing Support</a>
              <a href="#contact" className="text-gray-700 hover:text-red-600 py-2">Contact Us</a>
            </nav>
          </div>
        )}
      </div>
